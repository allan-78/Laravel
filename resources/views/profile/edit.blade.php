                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                @if(Auth::user()->profile_photo)
                                    <div class="mb-3">
                                        <img src="{{ Auth::user()->profile_photo }}" alt="Current Profile Photo" class="rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                                    </div>
                                @endif
                                ...
                                <small class="form-text text-muted">{{ __('Upload a new profile photo (max 2MB)') }}</small>
